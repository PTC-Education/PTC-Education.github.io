...
permalink: /docs/thought-leadership/webinars/resources
...
<object data="IoT-Course-Layout/Course-Layout.pdf" type="application/pdf" width="100%" height="700px">
    <embed src="IoT-Course-Layout/Course-Layout.pdf">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href="IoT-Course-Layout/Course-Layout.pdf">Download PDF</a>.</p>
    </embed>
</object>